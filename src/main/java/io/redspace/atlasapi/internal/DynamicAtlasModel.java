...
public final class DynamicAtlasModel implements ItemModel {
    ...
    /**
     * Client item model definition: {@code { "model": { "type": "atlas_api:dynamic_model", "handler": "..." } } }.
     */
    public record Unbaked(Identifier handler) implements ItemModel.Unbaked {
        ...
        public ItemModel bake(ItemModel.BakingContext context, Matrix4fc transformation) {
            return new DynamicAtlasModel(AtlasModelBaking.requireHandler(this.handler));
        }
